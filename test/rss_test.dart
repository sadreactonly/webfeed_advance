...
void main() {
  ...
  test('parse RSS-Podcast.xml', () {
    ...
    expect(feed.podcast?.trailers.first.url,
    ...
    expect(feed.podcast?.license!.href, null);
    ...
    expect(
        feed.podcast?.value!.valueRecipients.first.name, 'Alice (Podcaster)');
    ...
    expect(feed.items!.first.podcast?.season!.name,
        'Race for the Whitehouse 2020');
    ...
    expect(
        feed.items!.first.podcast?.alternateEnclosures.first.length, 7924786);
    expect(feed.items!.first.podcast?.alternateEnclosures.first.bitrate,
        511276.52);
    ...
    expect(
        feed.items!.first.podcast?.alternateEnclosures.first.sources.first.uri,
